...
##########
  ...
  # Planned contrast. Fit the model in a slightly different way ********************** UP TO HERE
  DisplayBgrd$pop_back_region <- with(DisplayBgrd, interaction(Population, Background_pop, BodyRegion))
  DisplayBgrd_pop_back_region <- lmer(dL ~ pop_back_region + (1|ID), data = DisplayBgrd) 
  summary(DisplayBgrd_pop_back_region)
  
  robust_DisplayBgrd_pop_back_region <- clubSandwich::conf_int(DisplayBgrd_pop_back_region, cluster = DisplayBgrd$ID, vcov =  "CR2")
