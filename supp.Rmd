...
##########
  ...
  DispBgrdAC_inter <- lmer(dL ~  Background_pop + BodyRegion + Background_pop : BodyRegion + (1|ID), data=DisplayBgrd_Hawaii)
  ...
  intearction_AC_Disp <- Wald_test(DispBgrdAC_inter, constraints = constrain_zero(6:8), 
