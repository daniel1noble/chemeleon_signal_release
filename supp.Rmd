...
<!-- ```{r tablehyp_prd, tab.align = 'center', tab.cap = "Hypotheses and associated predictions tested in this paper in relation to the population of interest, the receiver visual system used in visual modelling, and the background against which the contrast of the signal was calculated for chromatic and achromatic contrast "} -->
...
<!-- ```{r Figcolsig2, fig.align = 'center', fig.cap = "Representative photos of habitat in Hawaii (A, B) and Kenya (C, D). In both sites, chameleons favored well-vegetated trees and bushes, often with lots of vines."} -->
...
<!-- figs4 <- image_read("./output/figures/FigS4.png") -->
<!-- figs4 -->
