...
# Fit model testing this idea above
  Diff_dL <- lmer(dL_diff_abs ~ SVL + Population + (1|ID), data=Diff)
  summary(Diff_dL)
...
# Refit mdoel using robust standard errors
  robust_Diff_dl <- clubSandwich::conf_int(Diff_dL, cluster = Diff$ID, vcov =  "CR2") 
