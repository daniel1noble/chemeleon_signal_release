...
##########
    ...
    robust_ConspicDisplayAC_CI <- conf_int(ConspicDisplayAC, cluster = Display_1_IDs$ID, vcov = "CR2")
...
##########
 ...
 robust_ConspicCourtshipAC_CI <- conf_int(ConspicCourtshipAC, cluster = Courtship_IDs$ID, vcov = "CR2")
...
##########
  ...
  p_displ_AC <- as.numeric(result_DisplayBgrd_pop_back[2,8])
