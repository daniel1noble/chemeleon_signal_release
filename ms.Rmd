...
# Clean
 final_T1 <- table1 %>% 
             mutate(SocialContext = c("Male-Male Display", rep("", 5), "Courtship Display", rep("", 5)),
                    VisualRealm = c("Acromatic Contrast", rep("", 2), "Chromatic Contrast", rep("", 2), "Acromatic Contrast", rep("", 2), "Chromatic Contrast", rep("", 2))) %>%
...
# Clean
 final_T2 <- table2 %>% 
             mutate(JND = c("Acromatic Contrast", rep("", 3), "Chromatic Contrast", rep("", 3))) %>%
...
```{r table3, fig.width = 9, fig.height = 1, fig.asp = 0.1136364, tab.cap = "Mean differences between Hawaiian and Kenyan visual signals for snake and bird predators."}
...
```{r table4, fig.width = 9, fig.height = 1, fig.asp = 0.1136364, tab.cap = "Mean differences between Hawaiian lizards on introduced Hawaiian background and native Kenyan background."}
...
tb4 <- tb4 %>% mutate(SocialContext = c("Male-Male Display", rep("", 5), 
                    ...
                    VisualRealm = c("Acromatic Contrast", rep("", 2), "Chromatic Contrast", 
                                    rep("", 2), "Acromatic Contrast", rep("", 2), 
